...
?>
	<li class="comment <?php echo tp_comment_alt(); ?> clearfix ajax_com" id="comment-<?php echo get_comment_ID(); ?>">	
		<div id="comment-<?php comment_ID(); ?>" class="comment-wrap clear">
			<div class="comment-author">
				<?php echo get_avatar( $comment, $size = '42');?>
			</div>
			<div class="content alignleft">						
				<cite class="author clear">
					<?php if (get_comment_author_url()) :?>
					<a id="reviewer-<?php echo get_comment_ID() ;?>" href="<?php echo get_comment_author_url() ;?>" rel="nofollow" itemprop="author" target="_blank">
					<?php else :?>
					<span id="reviewer-<?php echo get_comment_ID() ;?>'" itemprop="author">
					<?php endif ;?>
					<?php comment_author() ?>
					<?php if(get_comment_author_url()) : ?>
					</a>
			...
			<div class="comment-right alignright">
				<div class="commentnum">
					<a href="<?php echo get_comment_link() ;?>	" rel="nofollow">#<?php echo ($comment_count + 1) ; ?>	</a>
				</div>
				<div class="reply">
					<a href="javascript:void(0)" data-name="<?php echo get_comment_author() ;?>" data-commentid="comment-<?php echo get_comment_ID() ;?>" rel="nofollow" style="display: none">Reply</a>
				</div>
			</div>
			<div class="clear"></div>
		</div>
