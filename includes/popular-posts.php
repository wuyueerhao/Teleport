...
class beauty_popular_posts_widget extends WP_Widget {
	...
	function beauty_popular_posts_widget() {
		...
		$args = array(
			...
			'description'	=> __( 'A widget to display popular post entries', 'beauty_dictionary' )
		);
		
		$this->WP_Widget( 'beauty_popular_posts_widget', Beauty . ' ' . __( 'Popular Posts', 'beauty_dictionary' ), $args );
	}
